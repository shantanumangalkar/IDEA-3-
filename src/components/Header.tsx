  ...
  return (
    <>
      ...
      >
        ...
        {/* Mobile Sidebar */}
        <div
          className={`absolute right-0 top-0 h-full w-80 bg-gradient-to-b from-gray-900 to-black border-l border-yellow-500/20 shadow-2xl transform transition-transform duration-300 ease-out ${
